...
-- | An 'Entity' can be converted to/from database-reprentation, and has primary key.
--
...
class (FromDbValues a, HasEntityName a, HasSqlColumns a, PrimaryKey f a, ToSqlValues a) => Entity a f
